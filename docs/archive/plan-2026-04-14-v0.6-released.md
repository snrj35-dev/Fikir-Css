...
4. `CHANGELOG.md` güncel tut — v0.5.0 → v1.0.0 geçiş notu
...
| npm publish | GA publish yapma; prerelease (`1.0.0-beta.1`) veya npm/CDN vaatlerini kaldır |
...
| `1.0.0-beta.1` publish | ✅ Zaten planda | — |
