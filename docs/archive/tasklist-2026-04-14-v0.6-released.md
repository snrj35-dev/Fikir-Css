# Fikir CSS — v1.0.0 Task List (M9–M12)
...
- [x] npm account / `NPM_TOKEN` secret eklendi — `fikir-css@1.0.0-beta.6` npm'de `@beta` dist-tag ile yayınlandı `(M9)` ← uzman önerisi
...
- [x] `CHANGELOG.md`'ye v1.0.0-beta Unreleased başlığı eklendi `(M9)`
