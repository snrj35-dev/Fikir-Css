# Contributor Documentation Path

> Last reviewed: 2026-04-11

Use this path if you want to propose RFCs, implement changes, and keep contributions aligned with roadmap scope.

## Step 1: Repository Baseline
- Read `CONTRIBUTING.md`.
- Read `README.md` and `docs/roadmap/support-matrix.md`.
- Check active scope in `docs/roadmap/plan.md` and `docs/roadmap/tasklist.md`.

## Step 2: Contracts and Specs
...
- Playground evaluation: `docs/community/how-to-evaluate-playground.md`.
