...
export const anatomyContract = {
  ...
  navbar: {
    ...
    elements: [
      ...
      { selector: "navbar-nav", role: "nav link list", element: "ul" },
      { selector: "navbar-item", role: "nav item", element: "li" }
    ],
    data_attrs: [],
    minimal_html: '<nav class="navbar">\n  <a class="navbar-brand" href="/">Brand</a>\n  <ul class="navbar-nav">\n    <li class="navbar-item"><a href="/about">About</a></li>\n    <li class="navbar-item"><a href="/docs">Docs</a></li>\n  </ul>\n</nav>',
    notes: "Does NOT provide fixed/sticky positioning — add position:fixed in app CSS if needed."
  },
  ...
  "sidebar-nav": {
    ...
    element: "nav",
    elements: [
      { selector: "sidebar-nav-section", role: "section heading", element: "div" },
    ...
    notes: "Use aria-current=\"page\" on active item."
  },
  ...
  timeline: {
    ...
    element: "div",
    elements: [
      { selector: "timeline-item", role: "single event entry", element: "div" },
      { selector: "timeline-marker", role: "event dot or icon", element: "div" },
  ...
  "app-shell": {
    ...
    notes: "Full application layout shell using CSS Grid."
  },
  ...
  "page-header": {
    ...
    data_attrs: [],
    minimal_html: '<div class="page-header">\n  <div class="page-header-content"><h1>Page Title</h1></div>\n  <div class="page-header-actions"><button class="btn btn-primary btn-md">New Item</button></div>\n</div>',
    notes: "Page-level header with title and actions."
  },
  ...
  "stat-group": {
    ...
    elements: [],
    data_attrs: [
      { attr: "data-variant", on: "root", values: ["compact", "divided"], description: "Layout variant." }
    ],
    minimal_html: '<div data-pattern="stat-group">\n  <!-- stat components -->\n</div>',
    notes: "Responsive grid wrapper for stat components. Variant 'divided' adds separator lines; 'compact' reduces spacing."
  },
